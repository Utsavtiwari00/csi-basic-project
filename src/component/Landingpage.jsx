...
const Landingpage = () => {
  ...
  //Navigation b/w components
  // const navigate = useNavigate();
//   const useCreateNavigationHandler = (navigateToPath) => { //Will accept the component to be navigated to as a parameter
...
// };
  ...
  // const handleNavigateToQuizPage = useCreateNavigationHandler('/quiz');
  const navigate = useNavigate();
